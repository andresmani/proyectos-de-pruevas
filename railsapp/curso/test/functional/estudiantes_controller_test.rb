...
class EstudiantesControllerTest < ActionController::TestCase
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post :create, estudiante: { apellido: @estudiante.apellido, cedula: @estudiante.cedula, direccion: @estudiante.direccion, nombre: @estudiante.nombre, telefono: @estudiante.telefono }
    end
  ...
  test "should update estudiante" do
    put :update, id: @estudiante, estudiante: { apellido: @estudiante.apellido, cedula: @estudiante.cedula, direccion: @estudiante.direccion, nombre: @estudiante.nombre, telefono: @estudiante.telefono }
    assert_redirected_to estudiante_path(assigns(:estudiante))
  end
