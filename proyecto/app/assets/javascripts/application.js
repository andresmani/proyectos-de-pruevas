...
$(document).ready(function() {
  ...
  $('a#show_pais_link').lazybox({closeImg: true});
...
$('#departamento_center_nombre').bind('railsAutocomplete.select', function(event, data){
$("#municipio_id").attr("value",data.item.id);
});
});